                    ...
                    @foreach($host->local_host_services as $service)
                        ...
                        <div class="col-lg-4 col-md-6 mb-4">
                            <div class="package-item bg-white mb-2">
                                <img class="img-fluid" src="{{ asset('assets/lhServiceCoverImage/'.$service->cover_photo) }}" style="height:200px;width:400px;" alt="">
                                <div class="p-4">
                                    ...
                                    <div class="">
                                        <div class="d-flex justify-content-between">
                                            ...
                                            @if($service->available=="Yes")
                                                ...
                                                <a href="{{ url('/place/'.$placeId.'/package/'.$packageId.'/host-service/'.$service->id) }}" class="btn btn-success ">Details</a>
