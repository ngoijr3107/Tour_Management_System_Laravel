    ...
    <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            <div class="text-center mb-3 pb-3">
                <h6 class="text-primary text-uppercase" style="letter-spacing: 5px;">Local Hosts</h6>
                <h1>Select Local Host</h1>
            </div>
            <div class="row">
                @foreach($localHosts as $host)

                    @foreach($host->local_host_services as $service)

                        @if($service->place_id==$placeId)

                        <div class="col-lg-4 col-md-6 mb-4">
                            <div class="package-item bg-white mb-2">
                                <img class="img-fluid" src="{{ asset('assets/lhRoomImage/'.$service->room_picture) }}" style="height:200px;width:400px;" alt="">
                                <div class="p-4">
                                    ...
                                    <div class="">
                                        <div class="d-flex justify-content-between">
                                            ...
                                            @if($service->available=="Yes")
                                                ...
                                                <a href="{{ url('/place/'.$placeId.'/premium-package/'.$packageId.'/host-service/'.$service->id) }}" class="btn btn-success ">Details</a>
