...
Route::middleware([
    ...
    Route::get('/add/super-admin', [SuperAdminController::class, 'addSuperAdminProcess'])->name('/add/super-admin/process');
    Route::post('/add/super-admin/process', [SuperAdminController::class, 'addSuperAdmin'])->name('/add/super-admin');
